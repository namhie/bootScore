...
<?php wp_body_open(); ?>
    <header class="header py-md-2 pt-lg-3">
        <div class="navbar navbar-expand-lg absolute-top py-0 bg-body-tertiary rounded">
          <div class="container-sm align-items-center justify-content-md-end justify-content-start py-md-0 py-2 bg-white mb-md-2"><a class="navbar-brand order-0 p-0 me-md-4 me-1" href="https://dev.x1team.ru"><img class="logo" src="https://dev.x1team.ru/wp-content/uploads/2023/01/logo.png" alt="logo"></a>
            ...
            <div class="offcanvas offcanvas-start text-bg-white" id="offcanvasNavbarMenu" aria-labelledby="offcanvasNavbarLabel">
              <div class="offcanvas-header">
                <div class="offcanvas-title"> <a class="logo" href="https://dev.x1team.ru"><img src="https://dev.x1team.ru/wp-content/uploads/2023/01/logo.png" alt="logo"></a></div>
